...
public abstract class AbstractList implements ListInterface  {
     ...
     * constructor.
     *
     * @param capacity the length of list at which it has to be initialised.
     */
     ...
     * Input : add(1, 2)
     *
     * First Move all the elements to the right by one upto the given index.
     * So, you will be having a gap at the given index where you can insert
     * a new element / item that is passed as parameter.
     * Output : [5,2,-2,3,1,6,-1]
     *
     * Can you think of the following works:
     * Let's say for example the List object contains : [5,-2,3,1,6,-1]
     * Input: add(20, 2) : As there are 6 elements, you can't insert an
     * element / item after 6th index.
     *
     * Output: [5,2,-2,3,1,6,-1]
     *
     * Think of on which object this method can be called.
     * List / OrderedList and etc.
     *
     * @param index the position in the list at which the item is to be placed.
     * @param item the item which is to be included in the list.
     */
     ...
     * this list, or it will be added in order if the list is OrderedList,
     ...
     *
     * @param item the item which has to be checked for.
     */
     ...
     *
     * @param item the item whose index is to be known.
     */
     ...
     * in this list, or -1 if this list does not contain the element.
     * More formally, returns the highest index i, or -1 if there is no such
     * index.
     *
