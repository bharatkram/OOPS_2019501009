...
public class List {
     ...
     * @param index the index of the item which has to be returned.
     * @return the item that is present at the specified index.
     */
     ...
     * @return the elements present in the list in string format.
     */
    ...
    /**
     * return true if the list has the item passed as argument to the method.
     * So, iterate through the list and return true if
     * the item exists and otherwise false
     * @param item the item whose presence has to be checked for.
     * @return true if the item is present in the list and false if not.
     */
     ...
     * @param item the item whose index has to be returned.
     ...
     * @param args the std. notation for main function.
     */
